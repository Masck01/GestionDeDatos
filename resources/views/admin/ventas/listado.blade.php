              ...
              <div class="card-body table-responsive p-0">
                ...
                <table class="table table-hover text-nowrap" id="datos">
                  ...
                  <thead>
                    ...
                    <tr>                    
                      <th style="text-align:center;"><a href="{{ route('ventas.seleccionar') }}" class="btn btn-link" data-toggle="tooltip" title="Nueva Venta" data-original-title="Generar Presupuesto"><i class="fas fa-plus"></i></a></th>
                      <th>Fecha</th>
                      <th>Hora</th>
                      <th>Estado</th>
                      <th>Total</th>                
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $venta->getFromHoraAttribute($venta->fecha) }}</td>
                        <td>{{ $venta->estado}}</td>
