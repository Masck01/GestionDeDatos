        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="input-group input-group-sm">
                    <input type="text" name="table_search" id="searchTerm" class="form-control float-right" placeholder="Buscar">
...
<!-- Modal -->
<div class="modal fade" id="EmpleadoModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('liquidacion.store')}}" method="post" class="d-flex justify-content-start flex-grow-1">
                    {{csrf_field()}}
                    {!! Form::select('meses',$meses,0,['class'=>'form-control']) !!}
                    <button type="submit" class="btn btn-primary p-1 ml-2">Liquidar en Batch</button>
                </form>
