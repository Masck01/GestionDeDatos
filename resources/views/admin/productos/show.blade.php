                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><b>Marca: </b>{{$producto->marcas->nombre}}</p>
                            <p><b>Precio de Venta: </b> {{ $producto->precioCompra }}</p>
                            <p><b>Precio de Compra: </b> {{ $producto->precioVenta }} </p>
                            <p><b>Stock: </b> {{ $producto->stock }} </p>
                            <p><b>Categoria: </b> {{ $producto->categoria->nombre }} </p>
                            <p><b>Proveedor: </b> {{ $producto->proveedor->razon_Social }} </p>
                            <p><b>Almacen: </b> {{ $producto->deposito->nombre }} </p>
                            <p><b>Capacidad: </b> {{ $producto->capacidad->nombre }} </p>
