            ...
            <form method="post" action="{{ route('productos.update',$producto->id)}}" role="form" enctype="multipart/form-data">
              ...
              <div class="row" style="margin-top: 16px;">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="precioPesosLista" name="precioCompra" value="{{$producto->precioCompra}}">
                    ...
                    <label for="precioLista">Precio Venta</label>
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="precioPesosLista" name="precioVenta" value="{{$producto->precioVenta}}">
              ...
              <label for="precioLista">Fecha Vencimiento</label>
                ...
                <div class="input-group">
                  ...
                  <input type="date" id="start" name="fechaVencimiento" value="{{$producto->fechaVencimiento}}" min="2020-10-01" max="2030-12-31">
              ...
              <div class="row" style="margin-top: 16px;">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control select2"  id="marcas" name="marcas_id">
                        ...
                        <option value="{{$producto->marcas->id}}">{{$producto->marcas->nombre}}</option>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control select2"  id="marcas" name="deposito_id">
                        
                        <option value="{{$producto->deposito->id}}">{{$producto->deposito->nombre}}</option>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <select class="form-control select2"  id="marcas" name="capacidad_id">
                                            ...
                                            <option value="{{$producto->capacidad->id}}">{{$producto->capacidad->nombre}}</option>
