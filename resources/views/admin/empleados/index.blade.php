                  ...
                  <table class="table table-hover text-nowrap">
                    <thead>
                      ...
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 12px;">                     
                        <a href="{{ route('empleados.create') }}" class="btn btn-link" data-toggle="tooltip" title="Agregar Producto" data-original-title="Ver Detalle"><i class="fas fa-plus" style="color: blue; font-size: 20px;"></i></a>
                      ...
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 92px; text-align:center;">email</th>
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 42px; text-align:center;">Cuit</th>
                    ...
                    <tbody>
                      @foreach ($empleados as $empleado)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('empleados.show', $empleado->id) }}" class="btn btn-link" data-toggle="tooltip" title="Ver empleado" data-original-title="Ver Detalle" style="text-align:center;" ><i class="far fa-eye" style="color:green; font-size: 20px;"></i></a>
                            <a href="{{ route('empleados.edit', $empleado->id) }}" class="btn btn-link" data-toggle="tooltip" title="Editar empleado" data-original-title="Editar Producto" style="text-align:center;" ><i class="fas fa-pencil-alt" style="color:black; font-size: 20px;"></i></a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
