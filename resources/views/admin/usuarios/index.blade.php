                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    <thead>
                      ...
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 92px; text-align:center;">Password</th>
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 42px; text-align:center;">Email</th>
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 42px; text-align:center;">Tipo Usuario</th>
                    ...
                    <tbody>
                      @foreach ($usuarios as $usuario)
                        <tr>
                          ...
                          <td style="text-align:center;">{{ $usuario->tipousuario }}</td>
                          <td>
