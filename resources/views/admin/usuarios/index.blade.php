                  ...
                  <table class="table table-hover text-nowrap">
                    <thead>
                      ...
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 12px;">                     
                        <a href="{{ route('usuarios.create') }}" class="btn btn-link" data-toggle="tooltip" title="Agregar Empleado" data-original-title="Ver Detalle"><i class="fas fa-plus" style="color: blue; font-size: 20px;"></i></a>
